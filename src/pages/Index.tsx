...
export default function Index() {
  ...
  const loadWorks = async (userId: number) => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            <CardTitle className="text-3xl font-bold text-center">Pro Portfolio</CardTitle>
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Avatar className="cursor-pointer" onClick={() => setShowSettings(true)}>
              ...
              {works.length === 0 ? (
                <div className="col-span-full text-center py-16">
                  ...
                  <p className="text-muted-foreground">
                    Добавьте первую работу в настройках
                  </p>
                </div>
              ) : (
                works.map((work) => (
      ...
      <Dialog open={showSettings} onOpenChange={setShowSettings}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Управление профилем и работами</DialogDescription>
          </DialogHeader>
          ...
          <Tabs defaultValue="profile" className="w-full">
            ...
            <TabsContent value="works" className="space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="font-semibold">Мои работы</h3>
                {works.map((work) => (
                  <div key={work.id} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center gap-3">
                      <img
                        src={work.image_url}
                        alt={work.title}
                        className="w-16 h-16 object-cover rounded no-select"
                        onContextMenu={(e) => e.preventDefault()}
                      />
                      <div>
